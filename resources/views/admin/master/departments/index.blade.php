...
@section('title', 'Departments · AddustDesk')
@section('page-title', 'Departments')
@section('page-subtitle', 'Kelola daftar department untuk eskalasi tiket.')
...
@section('content')
    ...
    @else
        ...
        <div class="bg-white border border-border rounded-xl py-16 px-6 flex flex-col items-center text-center">
            ...
            <p class="text-sm font-medium text-slate-900">Belum ada department</p>
            <p class="text-sm text-slate-500 mt-1">Department dipakai buat eskalasi tiket antar tim.</p>
            <a href="{{ route('admin.departments.create') }}"
